...
declare namespace WsN {
  ...
  type orderBooksServerWsObject = { create(params: orderBooksServerParams): Promise<void>; }
  /**
   * 
   * 
   * 
  ...
  type orderBooksClientWsObject = { connect(params: orderBooksClientParams): Promise<void>; };
  /**
   * 
   * 
   * 
